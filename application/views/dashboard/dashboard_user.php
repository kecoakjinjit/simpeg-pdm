                ...
                <table class="table table-sm">
                  ...
                  <?php foreach($identitas as $i) ?>
                    ...
                    <tr>
                      <td>Agama</td>
                      <td>:</td>
                      <td><?= $retVal = ($i['id_agama']) == 1 ? "Islam" :
                              $retVal = ($i['id_agama']) == 2 ? "Kristen/Protestan" : 
                              $retVal = ($i['id_agama']) == 3 ? "Katholik" : 
                              $retVal = ($i['id_agama']) == 4 ? "Hindu" : 
                              $retVal = ($i['id_agama']) == 5 ? "Budha" : 
                              $retVal = ($i['id_agama']) == 6 ? "Khong Hu Chu" : "Kepercayaan Kpd Tuhan YME"; ?></td>
                    </tr>
                    <tr>
                      <td>No telepon</td>
                      <td>:</td>
